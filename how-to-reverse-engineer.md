...
## The story this playbook came from

A senior engineer announced his retirement. He'd written a large C++ codebase at the core of a production system. The old reflex: book a flight, hire a replacement, hope for the best.

The new reflex: run this playbook.

Step 1 ran overnight with Claude reading the C++ and emitting specs. Step 2 captured a month of production I/O as fixtures. Step 3 was a two-hour meeting: rewrite in Python. Steps 4 and 5 are TDD and shadow replay, both cheap at current token prices.

A succession crisis became a token bill.
